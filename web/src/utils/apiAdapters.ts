...
export function apiProjectToProperty(apiProject: Project): Property {
  ...
  return {
    ...
    priceFrom: specs?.priceFrom as number | undefined,
    ...
    completionDate: specs?.completionDate as string | undefined,
    ...
    roi: specs?.roi as number | undefined,
    paymentPlan: specs?.paymentPlan as string | undefined,
