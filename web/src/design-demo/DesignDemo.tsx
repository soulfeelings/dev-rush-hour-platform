        ...
        <div className={styles.heroInner}>
          <div className={styles.heroContent}>
            ...
            <h1 className={styles.heroTitle}>
              Find Your <span className={styles.heroHighlight}>Dream Home</span>{" "}
              in Dubai
            </h1>
            <p className={styles.heroDesc}>
              Discover premium properties across Dubai's most prestigious
              neighborhoods. From luxurious villas to modern apartments.
            </p>
        ...
        >
          <div>
            ...
            <p className={styles.sectionSubtitle}>
              Handpicked selections for discerning buyers
            </p>
          </div>
          <button
      ...
      <section className={styles.features}>
        ...
        <div className={styles.videoBlock}>
          <div className={styles.videoFrame}>
            ...
            <svg
              className={styles.burjSilhouette}
              viewBox="0 0 60 200"
              fill="currentColor"
            >
              <path d="M30 0 L32 20 L35 20 L35 40 L38 40 L38 60 L40 60 L40 80 L42 80 L42 100 L44 100 L44 120 L46 120 L46 140 L48 140 L48 160 L50 160 L50 180 L55 180 L55 200 L5 200 L5 180 L10 180 L10 160 L12 160 L12 140 L14 140 L14 120 L16 120 L16 100 L18 100 L18 80 L20 80 L20 60 L22 60 L22 40 L25 40 L25 20 L28 20 Z" />
        ...
        <div className={styles.featuresGrid}>
          ...
          <div className={styles.featureCard}>
            ...
            <p className={styles.featureDesc}>
              Curated collection of the finest properties across Dubai's best
              locations.
            </p>
          </div>
          <div className={styles.featureCard}>
            ...
            <p className={styles.featureDesc}>
              Dedicated advisors to help you through every step of your property
              journey.
            </p>
          </div>
        </div>
      ...
      <section className={styles.cta}>
        <div className={styles.ctaInner}>
          ...
          <p className={styles.ctaDesc}>
            Join thousands of satisfied buyers who found their perfect property
            through RushHour.
          </p>
      ...
      <section className={styles.showcase}>
        <div className={styles.showcaseInner}>
          ...
          <div className={styles.showcaseSection}>
            ...
            <p className={styles.showcaseSubtitle}>
              Plus Jakarta Sans + Noto Naskh Arabic
            </p>
            <div className={styles.typographyDemo}>
              ...
              <p style={{ fontSize: "1rem" }}>
                Body text — 16px Regular. The quick brown fox jumps over the
                lazy dog.
              </p>
          ...
          <div className={styles.showcaseSection}>
            ...
            <p className={styles.showcaseSubtitle}>
              Inputs, selects, and validation states
            </p>
        ...
        <div className={styles.footerInner}>
          <div className={styles.footerGrid}>
            <div className={styles.footerBrand}>
              ...
              <p>
                Your trusted partner for premium real estate in Dubai. Find your
                dream home today.
              </p>
            </div>
          ...
          <div className={styles.footerBottom}>
            <p className={styles.footerCopyright}>
              © 2024 RushHour. All rights reserved.
            </p>
