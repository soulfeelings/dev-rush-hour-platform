...
INSERT INTO lots (status, project_id, type, bedrooms, bathrooms, area_sqm, floor, price_from_us, price_from_developer, roi, bonus_keys, badge_ids, data) VALUES
('active',
 (SELECT id FROM projects WHERE slug = 'sea-legend-tower-one'),
 'apartment', 3, 3, 142.5, 25, 1250000.00, 1500000.00, 7.0,
...
('active',
 (SELECT id FROM projects WHERE slug = 'sea-legend-tower-one'),
 'apartment', 3, 2, 138.0, 18, 1200000.00, 1440000.00, 6.5,
...
('active',
 (SELECT id FROM projects WHERE slug = 'sea-legend-tower-one'),
 'apartment', 3, 3, 145.0, 32, 1350000.00, 1620000.00, 7.5,
...
('active',
 ...
 'apartment', 1, 1, 65.0, 5, 1100000.00, 1320000.00, 6.0,
 '{"flexible_payment"}',
 '{}',
...
('active',
 (SELECT id FROM projects WHERE slug = 'colibri-views'),
 'studio', 0, 1, 45.0, 3, 750000.00, 900000.00, 5.5,
...
('active',
 (SELECT id FROM projects WHERE slug = 'colibri-views'),
 'apartment', 2, 2, 95.0, 8, 1450000.00, 1740000.00, 6.5,
...
('active',
 ...
 'apartment', 2, 2, 110.0, 12, 1650000.00, 1980000.00, 8.0,
...
('active',
 (SELECT id FROM projects WHERE slug = 'luz-ora-residences'),
 'apartment', 4, 4, 220.0, 20, 3200000.00, 3840000.00, 8.5,
...
('active',
 (SELECT id FROM projects WHERE slug = 'luz-ora-residences'),
 'apartment', 1, 1, 85.0, 7, 1400000.00, 1680000.00, 7.5,
...
('active',
 ...
 'apartment', 3, 3, 180.0, 15, 2800000.00, 3360000.00, 9.0,
...
('active',
 (SELECT id FROM projects WHERE slug = 'palm-jumeirah-residence'),
 'apartment', 2, 2, 130.0, 10, 2100000.00, 2520000.00, 8.5,
...
('active',
 (SELECT id FROM projects WHERE slug = 'palm-jumeirah-residence'),
 'villa', 4, 5, 350.0, 1, 5500000.00, 6600000.00, 9.5,
...
('active',
 ...
 'apartment', 1, 1, 75.0, 25, 1350000.00, 1620000.00, 7.0,
...
('active',
 (SELECT id FROM projects WHERE slug = 'downtown-dubai-tower'),
 'apartment', 2, 2, 115.0, 35, 1950000.00, 2340000.00, 7.5,
...
('active',
 (SELECT id FROM projects WHERE slug = 'downtown-dubai-tower'),
 'apartment', 3, 3, 160.0, 42, 2600000.00, 3120000.00, 7.0,
...
('active',
 ...
 'studio', 0, 1, 35.0, 8, 450000.00, 540000.00, 8.0,
 '{"compact_living"}',
 '{}',
...
('active',
 (SELECT id FROM projects WHERE slug = 'marina-studios'),
 'studio', 0, 1, 42.0, 15, 520000.00, 624000.00, 8.5,
...
('active',
 ...
 'villa', 5, 6, 650.0, 1, 15000000.00, 18000000.00, 5.0,
...
('active',
 (SELECT id FROM projects WHERE slug = 'palm-royal-villas'),
 'villa', 7, 8, 950.0, 1, 35000000.00, 42000000.00, 5.0,
...
('active',
 ...
 'apartment', 1, 1, 70.0, 12, 950000.00, 1140000.00, 7.0,
...
('active',
 (SELECT id FROM projects WHERE slug = 'marina-gate-ready'),
 'apartment', 2, 2, 105.0, 20, 1500000.00, 1800000.00, 7.5,
...
('active',
 ...
 'apartment', 2, 2, 120.0, 45, 1800000.00, 2160000.00, 12.0,
...
('active',
 (SELECT id FROM projects WHERE slug = 'dubai-creek-tower'),
 'apartment', 4, 4, 220.0, 60, 3800000.00, 4560000.00, 12.5,
...
('active',
 ...
 'apartment', 3, 3, 150.0, 5, 2200000.00, 2640000.00, 6.0,
...
('active',
 (SELECT id FROM projects WHERE slug = 'islands-family-homes'),
 'townhouse', 4, 4, 280.0, 1, 3500000.00, 4200000.00, 6.5,
...
('active',
 ...
 'studio', 0, 1, 38.0, 3, 550000.00, 660000.00, 4.0,
 '{"value_deal"}',
 '{}',
...
('active',
 (SELECT id FROM projects WHERE slug = 'al-hamra-value'),
 'apartment', 2, 2, 90.0, 6, 950000.00, 1140000.00, 4.5,
...
('active',
 ...
 'studio', 0, 1, 55.0, 30, 1100000.00, 1320000.00, 15.0,
...
('active',
 (SELECT id FROM projects WHERE slug = 'downtown-investment-suites'),
 'apartment', 1, 1, 75.0, 35, 1600000.00, 1920000.00, 14.5,
...
('active',
 ...
 'studio', 0, 1, 40.0, 5, 600000.00, 720000.00, 7.0,
 '{"marina_view"}',
 '{}',
...
('active',
 (SELECT id FROM projects WHERE slug = 'marina-complete-living'),
 'apartment', 2, 2, 110.0, 15, 1400000.00, 1680000.00, 7.5,
...
('active',
 (SELECT id FROM projects WHERE slug = 'marina-complete-living'),
 'penthouse', 5, 5, 400.0, 50, 5500000.00, 6600000.00, 8.0,
...
ON CONFLICT (project_id, type, bedrooms, bathrooms, area_sqm, floor, price_from_us) DO NOTHING;
